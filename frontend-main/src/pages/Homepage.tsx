...
export default function Homepage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (selectedTab === "meals") {
      ...
      const groceryCategories = ["groceries", "dairy", "beverages", "drinks", "food", "health"];
                  ...
                  return (
                    ...
                    >
                      <div className="relative">
                        ...
                        {product.isSponsored && (
                          <span className="absolute right-2 top-2 rounded bg-amber-400 px-2 py-1 text-[10px] font-bold text-black shadow">
                            Sponsored
                          </span>
                        )}
                      </div>
