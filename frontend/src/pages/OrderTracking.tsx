      ...
      <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <button 
            ...
            className="w-full mt-2 rounded-lg border border-red-200 bg-red-50 py-3 text-sm font-semibold text-red-600 transition hover:bg-red-100 cursor-pointer flex items-center justify-center gap-2"
          >
            Raise Dispute
          </button>
        </div>
