...
import { useOrders } from '@/hooks/useVendorQueries';
import { useUpdateOrderStatus } from '@/hooks/useVendorMutations';
              ...
              >
                ...
                >
                  <div className="flex-grow min-w-0">
                    ...
                    <h3 className="text-sm font-semibold text-foreground mt-1.5">{order.customerName || 'Unknown Customer'}</h3>
                    {!isExpanded && (
