...
export const createProduct = async (
	...
	try {
		const { name, description, price, stockQuantity, sku, category, categoryId, brand, oldPrice, weight, images, productType, preparationTime, modifiers, variants, dietaryTags } = req.body;
...
export { getCategories } from "./category.controller";
