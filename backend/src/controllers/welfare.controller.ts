...
// Welfare aliases
export const createWelfareEvent = createPromoEvent;
export const allocateWelfare = allocatePromo;
export const bulkAllocateWelfare = bulkAllocatePromo;
export const getWelfareReports = getPromoReports;
export const updateWelfareStatus = updatePromoStatus;
